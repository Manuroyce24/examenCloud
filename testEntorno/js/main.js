...
var white = document.body.querySelector('#botonWhite');
console.log(white);
var black = document.body.querySelector('#botonBlack');
console.log(black);
var css = document.querySelector('#estilos');
console.log(css);

function temaBlanco(){
    css.setAttribute("href", "css/whitestyle.css");
}

function temaNegro(){
    css.setAttribute("href", "css/blackstyle.css");
}
...
var password = document.getElementById('inputPassword');
var claveVac = document.querySelector("#mensajePasswordEmpty")
if(password.value === null || password.value === ''){
    reset();
    claveVac.textContent= "No se ha ingresado contraseña. Por favor ingrese una contraseña";
...
function armarEstructuraCadena(){
 ...
 var claveIngresada= document.getElementById("inputPassword").value;
 var caracter,secuencia=[];
 var i=0; 

/* Ejercicio 5. */
for (var i = 0; i < claveIngresada.length; i++) {
    var caracter = claveIngresada[i];
